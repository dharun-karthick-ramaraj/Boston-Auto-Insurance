 ...
 * @author Linata04
 */
public class StandardPackage extends javax.swing.JPanel {
    ...
    public StandardPackage(TheBostonInsuranceModel BIM, JPanel workPanel, CustomerQuote custQuote,Account account) {
        initComponents();
        this.BIM = BIM;
        this.workPanel = workPanel;
        this.custQuote = custQuote;
        this.account = account;
        custQuote.getQuote().setPackageType("standard");
        populatePage();
    }
    ...
    private void populatePage() {
        ...
        double discount = 0;
        Model.InsurancePackage.StandardPackage standardPackage = custQuote.getQuote().getStandardPackage();
        txtBI.setText(String.valueOf(standardPackage.getBodilyInjury(vehCount, rating)));
        txtPD.setText(String.valueOf(standardPackage.getPropertyDamage(vehCount, rating)));
        txtCL.setText(String.valueOf(standardPackage.getCollision(vehCount, rating)));
        txtCP.setText(String.valueOf(standardPackage.getComprehensive(vehCount, rating)));

        double Premium = standardPackage.calculateTotalAmount(vehCount, rating, discount);
