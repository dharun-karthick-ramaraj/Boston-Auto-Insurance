 ...
 * @author prane
 */
public class AddVehicleDetails extends javax.swing.JPanel {

    /**
     * Creates new form AddVehicleDetails
     */
    ...
    public AddVehicleDetails(TheBostonInsuranceModel BIM, JPanel workPanel, Account account, CustomerQuote custQuote) {
        initComponents();
        this.BIM = BIM;
